...
@include('layouts.breadcrumb', ['pageTitle' => 'Dashboard'])
                ...
                <div class="tab-content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6 col-lg-12 col-md-6">
                                            <div class="form-inner">
                                                ...
                                                <div class="nice-select" tabindex="0"><span class="current">Dhaka</span>
                                                    <ul class="list">
                                                        <li data-value="Dhaka" class="option selected">Dhaka</li>
                                                        <li data-value="Sylhet" class="option">Sylhet</li>
                                                        <li data-value="Chittagong" class="option">Chittagong</li>
                                                        <li data-value="Rajshahi" class="option">Rajshahi</li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-inner">
                                                ...
                                                <div class="nice-select" tabindex="0"><span
                                                    ...
                                                    <ul class="list">
                                                        ...
                                                        <li data-value="Afganistan" class="option">Afganistan</li>
                    ...
                    <div class="tab-pane fade" id="v-pills-order" role="tabpanel" aria-labelledby="v-pills-order-tab">
                        ...
                        <div class="table-title-area">
                            ...
                            <div class="nice-select" tabindex="0"><span class="current">Show: Last 05 Order</span>
                                <ul class="list">
                            ...
                            <table class="eg-table order-table table mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td data-label="Action"><button class="eg-btn action-btn green"><img alt="image"
                                    ...
                                    <tr>
                                        ...
                                        <td data-label="Action"><button class="eg-btn action-btn red"><img alt="image"
                                                    src="assets/images/icons/aiction-icon.svg"></button></td>
                                    </tr>
                                    <tr>
                    ...
                    <div class="tab-pane fade" id="v-pills-purchase" role="tabpanel"
                        ...
                        <div class="table-title-area">
                            <h3>All Purchase</h3>
                            <select id="order-category" style="display: none;">
                                <option value="01">Show: Last 05 Order</option>
                                <option value="02">Show: Last 03 Order</option>
                                <option value="03">Show: Last 15 Order</option>
                                <option value="04">Show: Last 20 Order</option>
