        ...
        <div class="row mb-4">
            <div class="col-md-12">
                ...
                <select name="price_range" class="form-control form-select select2" data-bs-placeholder="Select Price Range">
                    ...
                    <option value="{{ $priceRange }}" @selected($priceRange == request()->price_range)>{{ $priceRange->label() }} </option>
                    @endforeach
                </select>
        ...
        <div class="row mb-4">
            <div class="col-md-12">
                ...
                <select name="gateway" class="form-control form-select select2" data-bs-placeholder="Select Gateway">
                    ...
                    <option value="{{ $gateway }}" @selected($gateway == request()->gateway)>{{ $gateway->label() }} </option>
                    @endforeach
                </select>
